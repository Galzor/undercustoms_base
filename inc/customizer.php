...
function darkcustoms_customize_register_contact_info( $wp_customize ) {
  ...
  //footer info
  $wp_customize->add_setting('undercustoms_contact_info_footer_info',  array(
    'default'    =>  '',
    'transport'  =>  'postMessage'
  ));
  $wp_customize->add_control('undercustoms_contact_info_footer_info',  array(
    'section'   => 'undercustoms_contact_info_section',
    'label'     => 'Footer Info',
    'type'      => 'textarea',
  ));
...
function darkcustoms_customize_register_gallery_imgs( $wp_customize ) {
  ...
  $wp_customize->add_panel( 'undercustoms_gallery_panel', array(
    ...
    'description'    => 'Handmade custom Gallery slider by Amanz for his custom projects.',
  ));
